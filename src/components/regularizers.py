...
from src.components.layers import Conv3d, Deconv3d, SparseConv3d
...
class BasicRegularizer(nn.Module):
    def __init__(self, in_channels, c):
        ...
        self.deconv7 = Deconv3d(c*8, c*4, stride=2)
        self.deconv8 = Deconv3d(c*4, c*2, stride=2)
        self.deconv9 = Deconv3d(c*2, c*1, stride=2)
...
class CostRegNet(nn.Module):
    def __init__(self, in_channels, c, out_channels=1):
        ...
        self.deconv7 = Deconv3d(c * 8, c * 4, stride=(1, 2, 2), padding=1, output_padding=(0, 1, 1))
        self.deconv8 = Deconv3d(c * 4, c * 2, stride=(1, 2, 2), padding=1, output_padding=(0, 1, 1))
        self.deconv9 = Deconv3d(c * 2, c * 1, stride=(1, 2, 2), padding=1, output_padding=(0, 1, 1))
