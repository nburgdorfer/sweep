    ...
    def build_samples_stream(self, scene, frame_count):
        ...
        for ref_frame in range(frame_count):
            ...
            for ind in frame_inds:
                image_files.append(os.path.join(self.data_path, scene, "Images", f"{ind:08d}.png"))
                depth_files.append(os.path.join(self.data_path, scene, "Depths", f"{ind:08d}_depth.pfm"))
                pose_files.append(os.path.join(self.data_path, scene, "Cameras", f"{ind:08d}_cam.txt"))
